...
ipFolder = "Sample_Data/Sample_RefocVideo/Images/"; % Specifies the path to Input Images
...
pathToDepth = "Sample_Data/Sample_RefocVideo/Depthmaps/"; % Specifies the path to Depthmaps
depthFile = "depthMap_"; % eg: depthMapt_0 to depthMap_5  % Specifies file naming convention for Depthmap

opFolder = "Sample_Data/Sample_RefocVideo/Output/"; % Output Video is written to this Folder
