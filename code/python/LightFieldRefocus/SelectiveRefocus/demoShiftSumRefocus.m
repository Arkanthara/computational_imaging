...
inputPath = "Sample_Data/Sample_ShiftSum/"; % Specifies path to input sub-aperture images
...
title("All Views from Frame-"+string(frameOfInterest));
...
title("Refocused at Different Depths");