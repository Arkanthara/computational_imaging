...
img = io.imread(os.path.join(inputPath, "painter.png"))               # Load Image
depthMap = io.imread(os.path.join(inputPath, "painter-depth.png"))    # Load Corresponding Depth Map
...
plt.title('Stack of Books Focused')
plt.axis('off')
plt.show()
...
plt.figure()
plt.imshow(resultEasel)
plt.title('Easel on Left Side Refocused')
plt.axis('off')
plt.show()
...
plt.figure()
plt.imshow(resultBackPaintings)
plt.title('Paintings and Sculpture at the Back Refocused')
plt.axis('off')
plt.show()
...
plt.figure()
plt.imshow(resultAllFore)
plt.title('Back to Books')
plt.axis('off')
plt.show()
