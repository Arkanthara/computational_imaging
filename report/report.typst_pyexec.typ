...
#figure(grid(columns: 2, [#figure(image(".typst_pyexec/figures/cell_2_1_1.svg", width: 100%), kind: "subfigure", caption: [use_t_next=False]) <fig7-a>], [#figure(image(".typst_pyexec/figures/cell_2_1_2.svg", width: 100%), kind: "subfigure", caption: [use_t_next=True]) <fig7-b>]), caption: [Schedule comparison for `strategy=mask` (baseline: `schedule=const`)], kind: image) <fig7>
...
#figure(grid(columns: 2, [#figure(image(".typst_pyexec/figures/cell_3_1_1.svg"), kind: "subfigure", caption: [strategy=mask]) <fig8-a>], [#figure(image(".typst_pyexec/figures/cell_3_1_2.svg"), kind: "subfigure", caption: [strategy=target]) <fig8-b>]), caption: [Fixed vs. non-fixed noise addition for different strategies #linebreak() (baseline: `use_t_next=False`)], kind: image) <fig8>
...
#figure(grid(columns: 2, [#figure(image(".typst_pyexec/figures/cell_4_1_1.svg"), kind: "subfigure", caption: [strategy=mask]) <fig9-a>], [#figure(image(".typst_pyexec/figures/cell_4_1_2.svg"), kind: "subfigure", caption: [strategy=target]) <fig9-b>]), caption: [Increase the noise in the sampling process (`renoise_factor`) for `use_t_next=True` #linebreak() (baseline: `renoise_factor=1.0`)], kind: image) <fig9>
